...
const Header = () => {
    ...
    return (
        <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary/[0.70] backdrop-blur-xl'>
            {/* desktop & tablet */}
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <Link to={"/"} className="flex items-center gap-2">
                    <img src={Logo} className="w-8 object-cover" alt="logo"/>
                    <p className='text-headingColor text-xl font-bold'>FoodRunner</p>
                </Link>
                        ...
                        />
                        {
                            isMenu && (
                                <motion.div
                                    ...
                                    className="w-40 bg-gray-50 bg-primary drop-shadow-xl rounded-lg flex flex-col absolute top-12 right-0 px-4 py-2">

                                    {user && user.email === "sadmansakib11@iut-dhaka.edu" &&
                                        (
                                            <Link to={"/createItem"}>
                ...
                rounded-full"
                    ...
                    />
                    {
                        ...
                        duration-100 ease-in-out text-textColor text-base"
                                ...
                                <p className="m-2 p-2 rounded-md shadow-md px-4 py-2 flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all
                                    duration-100 ease-in-out text-textColor text-base"
                                   onClick={logout}>Logout<MdLogout/></p>
