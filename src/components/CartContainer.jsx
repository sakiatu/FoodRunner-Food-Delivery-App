    ...
    return (
        ...
        flex-col z-[100]">
            <div className="w-full flex items-center justify-between p-4 cursor-pointer">
                ...
                <p className="text-textColor text-lighttextGray font-semibold">Cart</p>
            ...
            <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
                ...
                justify-evenly px-8 py-2">
                    ...
                    <div className="w-full flex items-center justify-between">
                        ...
                        <p className="text-gray-400 text-lg">BDT 250</p>
                    </div>
                    ...
                    {user ? (
                        <motion.button
                            whileTap={{scale: 0.8}}
                            type="button"
                            className="w-full p-2 rounded-full bg-gradient-to-tr from-orange-400 to-orange-400
