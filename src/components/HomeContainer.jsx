        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
            <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
                ...
                <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
                    Are you hungry? Craving for your favorite food? Maybe try some new menu? FoodRunner is here!
                    FoodRunner is Bangladesh’s first premium online food delivery service.
                </p>
                    ...
                    {heroData && heroData.map(n => (
                        ...
                        rounded-3xl flex flex-col items-center justify-center drop-shadow-lg">
                            ...
                            <p className="text-sm font-semibold text-headingColor">
                                <span className="text-xs text-red-600">BDT</span> {n.price}
                            </p>
                        </div>
                    ))}
